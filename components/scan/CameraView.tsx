    ...
    <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                  ...
                  <div className="flex items-center justify-center space-x-4">
                    <span
                      className={`flex items-center ${
                        stream ? "text-green-400" : "text-gray-400"
                      }`}
                    >
                      <div
                        className={`w-2 h-2 rounded-full mr-2 ${
                          stream ? "bg-green-400" : "bg-gray-400"
                        }`}
                      ></div>
                      Stream
                    </span>
                    <span
                      className={`flex items-center ${
                        cameraReady ? "text-green-400" : "text-gray-400"
                      }`}
                    >
                      <div
                        className={`w-2 h-2 rounded-full mr-2 ${
                    ...
                    <span
                      className={`flex items-center ${
                        videoLoaded ? "text-green-400" : "text-gray-400"
                      }`}
                    >
                      <div
                        className={`w-2 h-2 rounded-full mr-2 ${
                          videoLoaded ? "bg-green-400" : "bg-gray-400"
                        }`}
                      ></div>
                      Video
                    </span>
      ...
      <div className="text-center space-y-2">
        <p className="text-sm sm:text-base text-gray-600">
          📱 <span className="font-medium">Pro Tip:</span> Hold your device
          steady and ensure good lighting
        </p>
